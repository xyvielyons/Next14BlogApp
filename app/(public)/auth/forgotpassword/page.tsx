          ...
          <div className="w-full md:w-5/12 md:mt-24">
              <div className="bg-creamywhite m-10 p-7 rounded-2xl space-y-2 shadow-md">
                  <div className="space-y-2">
                      <h1 className='font-bold text-secondarycolor text-2xl'>Please Enter your Email
Address to recover your account 🙂</h1>
                  </div>
                 
                  <div className="">
                    <form className='space-y-2'>
                      <Input type="text" placeholder="Email" className='rounded-full'></Input>
