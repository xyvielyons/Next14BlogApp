'use client'
import SignInSvg from '@/public/undraw_secure_login_pdn4.svg'
           ...
           <div className='mt-0 md:mt-5 md:w-7/12'>
              <div className="relative flex justify-center items-center">
                  <div className="absolute top-20 p-28 ml-10">  
                    <Image className='' src={SignInSvg} width='1024' height='768' alt='signup blob'></Image>
                  </div>
...
<rect width="40.0073" height="40.9408" fill="white" transform="translate(0.0983887 0.288116)"/>
                    ...
                    </svg></span>Login with Google</Button>
...
<rect width="42.266" height="42.266" fill="white" transform="translate(0.882324 0.845612)"/>
                  ...
                  <div className="">
                    ...
                    <FormField 
                                ...
                                render={({field})=>(
                                  <FormItem>
                                    ...
                                    <FormControl>
                                    <Input {...field} type="email" placeholder="Email" disabled={isPending} className={`rounded-full focus:border-accentcolor ${errors.email?.message ? "border-red-500 outline-none border-2":""}`}></Input>
                                    </FormControl>
                                    <FormMessage/>
                                  </FormItem>
                                )}
                            ...
                            <FormField 
                                ...
                                render={({field})=>(
                                  <FormItem>
                                    {/* <FormLabel>FirstName</FormLabel> */}
                                    <FormControl>
                                    <Input {...field} id='password' type="password" placeholder="********" disabled={isPending} className={`rounded-full focus:border-accentcolor ${errors.password?.message ? "border-red-500 outline-none border-2":""}`} ></Input>
                                    </FormControl>
                                    <FormMessage/>
                                  </FormItem>
                                )}
                    ...
                    <Button variant='socials' type='submit' className='w-full'disabled={isPending}>
                      {isPending && <ReloadIcon className="mr-2 h-4 w-4 animate-spin" />}<span>Login</span></Button>
                  ...
                  <p><Link href='/auth/register' className='hover:text-accentcolor'>Have an account?</Link></p>
