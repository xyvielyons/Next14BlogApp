                  ...
                  <div className="">
                    <Form {...form}>
                        <form className='space-y-2' onSubmit={form.handleSubmit(onSubmit)}>
                            <FormField 
                                ...
                                render={({field})=>(
                                  <FormItem>
                                    ...
                                    <FormControl>
                                      <Input {...field} disabled={isPending} id='firstName' type="text" placeholder="First Name" className={`rounded-full focus:border-accentcolor ${errors.firstName?.message ? "border-red-500 outline-none border-2":""}`}></Input>
                                    </FormControl>
                                    <FormMessage/>
                                  </FormItem>
                                )}
                            ...
                            <FormField 
                                ...
                                render={({field})=>(
                                  <FormItem>
                                    {/* <FormLabel>FirstName</FormLabel> */}
                                    <FormControl>
                                    <Input {...field} disabled={isPending} id='lastName' type="text" placeholder="Last Name" className={`rounded-full focus:border-accentcolor ${errors.lastName?.message ? "border-red-500 outline-none border-2":""}`} ></Input>
                                    </FormControl>
                                    <FormMessage/>
                                  </FormItem>
                                )}
                            ...
                            <FormField 
                                ...
                                render={({field})=>(
                                  <FormItem>
                                    {/* <FormLabel>FirstName</FormLabel> */}
                                    <FormControl>
                                    <Input {...field} id='email' disabled={isPending} type="email" placeholder="Email" className={`rounded-full focus:border-accentcolor ${errors.email?.message ? "border-red-500 outline-none border-2":""}`} ></Input>
                                    </FormControl>
                                    <FormMessage/>
                                  </FormItem>
                                )}
                            ...
                            <FormField 
                                ...
                                render={({field})=>(
                                  <FormItem>
                                    {/* <FormLabel>FirstName</FormLabel> */}
                                    <FormControl>
                                    <Input {...field} id='password' disabled={isPending} type="password" placeholder="password" className={`rounded-full focus:border-accentcolor ${errors.password?.message ? "border-red-500 outline-none border-2":""}`}></Input>
                                    </FormControl>
                                    <FormMessage/>
                                  </FormItem>
                                )}
                            ...
                            <FormField 
                                ...
                                render={({field})=>(
                                  <FormItem>
                                    {/* <FormLabel>FirstName</FormLabel> */}
                                    <FormControl>
                                    <Input {...field} id='confirmPassword' disabled={isPending} type="password" placeholder="confirm password" className={`rounded-full focus:border-accentcolor ${errors.confirmPassword?.message ? "border-red-500 outline-none border-2":""}`}></Input>
                                    </FormControl>
                                    <FormMessage/>
                                  </FormItem>
                                )}
                          ...
                          <Button variant='socials' disabled={isPending} type='submit' className='w-full'>{isPending && <ReloadIcon className="mr-2 h-4 w-4 animate-spin" />}<span>Register</span></Button>
                        </form>
